...
export const modalFormStore = {
    ...
    createWearable: (props) => <ManageWearable type="wearable" {...props} />,
    editWearable: (props) => <ManageWearable type="wearable" {...props} />,
    createColor: (props) => <ManageWearable type="color" {...props} />,
    editColor: (props) => <ManageWearable type="color" {...props} />,
    createWallpaper: (props) => <ManageWearable type="wallpaper" {...props} />,
    editWallpaper: (props) => <ManageWearable type="wallpaper" {...props} />,
